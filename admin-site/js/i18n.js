...
(function () {
  ...
  var STRINGS = {
    ja: {
      ...
      "photo.hintFull": "写真は最大5枚です。差し替えるには、どれか削除してください。",
      "photo.alt": "写真 {n}",
      "photo.remove": "写真 {n} を削除",
      "photo.err.max": "写真は最大5枚までです。",
      "photo.err.type": "画像ファイルを選んでください。",

      "carousel.region": "写真",
      "carousel.prev": "前の写真",
      "carousel.next": "次の写真",
      "carousel.goto": "{n}枚目を表示",
    ...
    en: {
      ...
      "photo.hintFull": "Up to 5 photos. Delete one to swap it out.",
      "photo.alt": "Photo {n}",
      "photo.remove": "Remove photo {n}",
      "photo.err.max": "You can add up to 5 photos.",
      "photo.err.type": "Please choose an image file.",

      "carousel.region": "Photos",
      "carousel.prev": "Previous photo",
      "carousel.next": "Next photo",
      "carousel.goto": "Show photo {n}",
